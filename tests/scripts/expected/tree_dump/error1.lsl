      ...
      ast node list [none] (cv=) (22,1)
        event handler [none] (cv=) (24,5)
          ...
          compound statement [none] (cv=) (24,32)
            ...
            if [none] (cv=) (49,9)
              function call [none] (cv=) (49,13)
                identifier "llOwnerSay" [none] (cv=) (49,13)
                ast node list [none] (cv=) (49,13)
                  constant expression [string] (cv=string constant: "") (49,24)
                    string constant: "" [string] (cv=string constant: "") (49,24)
              compound statement [none] (cv=) (49,29)
              null
            while [none] (cv=) (50,9)
              function call [none] (cv=) (50,16)
                identifier "llOwnerSay" [none] (cv=) (50,16)
                ast node list [none] (cv=) (50,16)
                  constant expression [string] (cv=string constant: "") (50,27)
                    string constant: "" [string] (cv=string constant: "") (50,27)
              compound statement [none] (cv=) (50,32)
            do [none] (cv=) (51,9)
              compound statement [none] (cv=) (51,12)
              function call [none] (cv=) (51,22)
                identifier "llOwnerSay" [none] (cv=) (51,22)
                ast node list [none] (cv=) (51,22)
                  constant expression [string] (cv=string constant: "") (51,33)
                    string constant: "" [string] (cv=string constant: "") (51,33)
            for [none] (cv=) (52,9)
              ast node list [none] (cv=) (52,9)
              function call [none] (cv=) (52,16)
                identifier "llOwnerSay" [none] (cv=) (52,16)
                ast node list [none] (cv=) (52,16)
                  constant expression [string] (cv=string constant: "") (52,27)
                    string constant: "" [string] (cv=string constant: "") (52,27)
              ast node list [none] (cv=) (52,9)
              compound statement [none] (cv=) (52,33)
        event handler [none] (cv=) (55,5)
          identifier "touch_start" [none] (cv=) (55,5)
          event decl [none] (cv=) (55,5)
          compound statement [none] (cv=) (55,19)
        event handler [none] (cv=) (58,5)
          identifier "at_target" [none] (cv=) (58,5)
          event decl [none] (cv=) (58,5)
            identifier "i" [integer] (cv=) (58,23)
            identifier "v" [vector] (cv=) (58,33)
            identifier "s" [string] (cv=) (58,43)
          compound statement [none] (cv=) (58,46)
